...
\todo{The first application of the framework and experimental procedure was carried out as a proof of principle. No aims of statistical significance were pursued. The framework is still incomplete in the data analysis part, therefore it is not possible to compute and analyze the eye parameters from the eye tracking record yet, preventing to find any significant pattern in the data.
...
The experiments took place at the home of the family of one of the participants. Two attempts were made in order to find a spot in the home which was suitable enough to have good calibration, for a couple of reasons:
\begin{enumerate}
...
The detailed research protocol is available in \todo{Appendix XX}. Here it follows a summary.
