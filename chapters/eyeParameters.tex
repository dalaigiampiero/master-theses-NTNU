...
\begin{small}
    Section~\ref{sec:eyeparameters} highlights
    \begin{itemize}
        \item Eye movements are distinguished by different anatomical and neural circuits and they serve specific purposes. The different types of eye movement can be operationalized and measured through eye tracking.
        \item Fizations, saccades and smooth pursuit eye movements are the types of eye movement most extensively studied in ASD.
        \item Divergent patterns in ASDg eye movements from TDg could indicate potential delays and deficiencies.
    \end{itemize}
\end{small}}}
\newline
...
\fbox{\parbox{.95\textwidth}{
\begin{small}
    Section~\ref{sec:smoothpursuittheory} highlights
    \begin{itemize}
        \item Smooth pursuit requires the correct functioning and integration of several brain regions (among which the cerebellum). Smooth pursuit impairments could highlight neurodevelopmental disorders.
        \item Smooth pursuit articulates in two phases: open loop (\(\leq\) 100 ms, visually guided) and closed loop (\textgreater 100, predictive).
        \item The main smooth pursuit parameter is the gain (position or velocity difference with the target motion).
        \item Smooth pursuit is present in children since 2 months of age, and it improves while the children grow.
        \item ASDg show significative abnormalities in smooth pursuit gain.
    \end{itemize}
\end{small}}}
\newline
...
\fbox{\parbox{.95\textwidth}{
\begin{small}
    Section~\ref{sec:saccadestheory} highlights
    \begin{itemize}
        \item Saccades are basic components of the oculomotor system and their impairment can affect development of sensorimotor, attentional, and cognitive functions in children.
        \item Saccades can be volitional or reflexive, and their parameters are amplitude, duration, latency, accuracy (gain), peak velocity
        \item The study of saccades in ASDg can reveal different functioning of parts of the brain like brainstem and cerebellum.
        \item ASDg does not show consistent impairment in primary saccade parameters, but just in standard deviation of saccade gain (saccade dysmetria), which could be reliable predictor of ASD.
    \end{itemize}
\end{small}}}
\newline
...
\fbox{\parbox{.95\textwidth}{
\begin{small}
    Section~\ref{sec:fixationsstheory} highlights
    \begin{itemize}
        \item Fixation parameters in ASDg are comparable to TDg.
        \item Fixations on areas of interest (AOI) showing social contents have been investigated extensively in ASDg.
        \item Ecological validity impacts on the social relevance of the experimental stimuli, rendering difficult to find consistent results in literature.
        \item It is impractical to assess fixations in the eye tracking framework under development, therefore they are not investigated further.
    \end{itemize}
\end{small}}}
\newline
...
\fbox{\parbox{.95\textwidth}{
\begin{small}
    Section~\ref{sec:eyerelatedevents} highlights
    \begin{itemize}
        \item Pupillary responses and eye blinks are interesting parameters, but for now they are not included in the framework due to methodological and ecological validity issues.
        \item ASDg seem to show smaller pupil size while attending face stimuli, while TDg show dilation, and overall ASDg show lower mean pupil size.
        \item Pupillary response is influenced by the amount of light in the environment and by a series of setting-related issues.
        \item ASDg shows lack of eye blink synchronization with speakers who are acting in video clips.
        \item Eye blink synchronization is particularly related to the ecological validity of experimental setting and stimuli, and to the ability to process verbal communication and  language.
    \end{itemize}
\end{small}}}
\newline
