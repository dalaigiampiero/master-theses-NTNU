...
\setthesistitle{Eye tracking as a supporting diagnostic tool
...
\setthesisauthor{Giampiero Dalai}
\setthesissupervisor{Prof. Frode Strand Volden}
\setthesissupervisorA{Prof. Sashidharan Komandur}  % if you have a second supervisor add it like this
%\setthesissupervisorB{Prof. Smart Guy}  % if you have a second supervisor add it like this


\nmtkeywords{autism spectrum disorders, ASD, eye tracking, eye movements, gaze pattern, eye parameters, test design, diagnosis, assessment, children, infants}
