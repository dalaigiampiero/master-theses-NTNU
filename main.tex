...
\include{chapters/introduction} % includes latex files from the same directory
\include{chapters/packages} % could be called Methodology or methods or any filename 
\include{chapters/structure} % could be results
